...
function attachGlobalErrorHandling() {
  ...
  function logAndDie(e) {
    ...
    console.error(BG_RED + 'yerna: this is probably a bug in Yerna itself, please file an issue!');
    console.error(BG_RED + 'yerna: NOTE: package.jsons or links may be in an inconsistent state');
    console.error(BG_RED + 'yerna: NOTE: child processes may be abandoned');
    process.exit(1);
  }
